...
export async function createAutomationLogHandler(req: Request, res: Response) {
    try {
...
export async function getAllAutomationLogsHandler(req: Request, res: Response) {
    try {
...
export async function getAutomationLogByIdHandler(req: Request, res: Response) {
    try {
