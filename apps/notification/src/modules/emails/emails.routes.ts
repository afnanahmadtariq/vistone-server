...
import { sendOrganizationMemberInvitationEmailHandler, sendClientPortalInvitationEmailHandler, sendTeamInvitationEmailHandler, genericEmailSendingEndpointHandler, sendProjectAssignmentEmailHandler } from "./emails.controller";
...
router.post('/project-assigned', validateRequest(emailsSchema), sendProjectAssignmentEmailHandler);
